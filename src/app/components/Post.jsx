    ...
    <form onSubmit={onDelete}>
      ...
      <div className=' flex flex-col'>
        ...
        {isEditing ? (
          ...
          rows="5"
          />
          <button className="bg-blue-600 text-white p-2 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300" type='submit'>Update</button>
          </form>
        ) : (
